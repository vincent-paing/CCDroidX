...
class NotificationManager @Inject constructor(
    ...
    companion object {
        ...
        private const val CHANNEL_ID_BUILD_SUCCESS_AFTER_FAIL =
            "channel_id_build_success_after_fail"
    }
    ...
    init {
        val notificationChannelGroup =
            NotificationChannelGroupCompat.Builder(CHANNEL_GROUP_ID_BUILD_ALERT)
                ...
                .setDescription(context.getString(R.string.channel_group_build_alert_desc)).build()
    ...
    fun notifyProjectFail(projectName: String, url: String) {
        ...
        val channel =
            NotificationChannelCompat.Builder(CHANNEL_ID_BUILD_FAIL, importance).setName(name)
                .setDescription(descriptionText).setGroup(CHANNEL_GROUP_ID_BUILD_ALERT).build()
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID_BUILD_FAIL)
            ...
            .setSmallIcon(R.drawable.ic_notification).setColor(context.getColor(R.color.build_fail))
            .setAutoCancel(true).setContentIntent(notifyPendingIntent).build()
    ...
    fun notifyProjectSuccessAfterFail(projectName: String, url: String) {
        ...
        val descriptionText =
            context.getString(R.string.channel_build_alert_success_after_fail_desc)
        val importance = NotificationManagerCompat.IMPORTANCE_DEFAULT
        val channel =
            NotificationChannelCompat.Builder(CHANNEL_ID_BUILD_SUCCESS_AFTER_FAIL, importance)
                .setName(name).setDescription(descriptionText)
                .setGroup(CHANNEL_GROUP_ID_BUILD_ALERT).build()
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID_BUILD_SUCCESS_AFTER_FAIL)
            .setContentTitle(
                context.getString(
                    R.string.notification_success_after_fail_title, projectName
                )
            ).setContentText(context.getString(R.string.notification_success_after_fail_content))
            .setSmallIcon(R.drawable.ic_notification)
            .setColor(context.getColor(R.color.build_success)).setContentIntent(notifyPendingIntent)
